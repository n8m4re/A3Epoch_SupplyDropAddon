...
_coords = getArray( configFile >> "sdropCfg" >> worldname >> "coords");
_coords = _coords call BIS_fnc_findSafePos;
...
[_supplyHeli,_heliSpawnPosition] spawn SDROP_AI_CleanUp;
...
if (!isNull _crate) then {
	[_crate] spawn SDROP_Crate_CleanUp;
}